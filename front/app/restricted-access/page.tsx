      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <p className="text-sm font-medium text-red-600">No tienes permiso para acceder a esta página</p>
          </div>
          
          <p className="text-gray-600 mb-6">
            Esta página está restringida para tu perfil de usuario. 
            Por favor, regresa al Dashboard o contacta al administrador 
