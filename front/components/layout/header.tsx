...
export function Header({ user,collapsed }: HeaderProps) {
  ...
  >
      ...
      <AnimatePresence mode="wait">
        {showSearch ? (
          <motion.div
            ...
            className="relative ml-auto flex-1 md:max-w-md"
          >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="ml-2 h-10 w-10 rounded-full hover:bg-muted transition-colors"
        onClick={toggleTheme}
      >
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="relative ml-2 h-10 w-10 rounded-full hover:bg-muted transition-colors"
          >
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="icon" className="ml-4 h-10 w-10 rounded-full p-0">
      ...
      <Button variant="ghost" size="icon" className="ml-2 h-10 w-10 rounded-full md:hidden">
