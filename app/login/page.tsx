...
export default function LoginPage() {
  ...
  return (
      ...
      >
        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants} className="w-full max-w-md z-10">
          <Card className="overflow-hidden border-none shadow-xl bg-white/90 backdrop-blur-xl">
            <CardHeader className="relative z-10 space-y-1 pb-8 pt-8">
              ...
              <motion.div variants={itemVariants}>
                <CardTitle className="text-2xl font-bold text-center">Accenture HR</CardTitle>
              </motion.div>
              <motion.div variants={itemVariants}>
              ...
              <AnimatePresence mode="wait">
                {success ? (
                    ...
                    >
                      ...
                      <h3 className="text-xl font-semibold mb-2">¡Inicio de sesión exitoso!</h3>
                      <p className="text-muted-foreground text-center">Redirigiendo al dashboard...</p>
                    </motion.div>
                ) : (
                    <motion.form
