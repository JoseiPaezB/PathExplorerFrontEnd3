...
export default function DashboardPage() {
  const [asignacionValue] = useState(75)
            ...
            <div className="flex items-center justify-center">
              <div className="relative h-40 w-40 flex items-center justify-center">
                <svg className="h-full w-full -rotate-90" viewBox="0 0 100 100">
                  <circle className="stroke-white/20 stroke-[8] fill-none" cx="50" cy="50" r="40" />
                  <motion.circle
          ...
          <CardContent className="px-6 pb-2">
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium">AWS Solutions Architect</span>
                    <Badge className="bg-amber-500 text-white">30 días</Badge>
                  </div>
                  <span className="text-xs text-muted-foreground">Vence: 15/04/2025</span>
                </div>
                <Progress value={25} className="h-2 bg-muted" indicatorClassName="bg-amber-500" showAnimation={true} />
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium">Scrum Master</span>
                    <Badge className="bg-emerald-500 text-white">60 días</Badge>
                  </div>
              ...
              <div className="space-y-2">
                ...
                <Progress value={75} className="h-2" showAnimation={true} animationDuration={2} />
              </div>
            </div>
          </CardContent>
          <CardFooter className="justify-between border-t px-6 py-4">
